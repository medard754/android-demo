...
public class calculatrice extends AppCompatActivity {
    ...
    /* public boolean onCreateOptionsMenu(Menu menu){
            ...
            //cette méthode nous montre que nous avons recupéré l'activity menu.xml
            MenuItem.OnActionExpandListener onActionExpandListener=new MenuItem.OnActionExpandListener() {
                @Override
                public boolean onMenuItemActionExpand(MenuItem item) {
                    Toast.makeText(Calculatrice.this,"search is expended",Toast.LENGTH_LONG).show();
                    return true;
                }
                @Override
                public boolean onMenuItemActionCollapse(MenuItem item) {
                    Toast.makeText(Calculatrice.this,"search is collapse",Toast.LENGTH_LONG).show();
                    return true;
                }
            };
            menu.findItem(R.id.searchview1).setOnActionExpandListener(onActionExpandListener);
            return true;
        }*/
    ...
    public void onBackPressed() {
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                calculatrice.super.onBackPressed();
            }
        })
